package com.nortal.assignment.customer.messagesource;
...
public abstract class DatabaseMessageSourceBase extends AbstractMessageSource {
	...
	public void init() {
		...
		messages = jdbcTemplate.query(i18nQuery,
	...
	protected static final class Messages {
		...
		public String getMessage(String code, Locale locale) {
			...
			Map<Locale, String> data = messages.get(code);
			return data != null ? (data.get(currentLocale)) != null ? data
					.get(currentLocale) : data.get(new Locale("en_US")) : null;
		}
	}
